import { FIELD_PIXELS } from '../constants.ts';
import { Direction, SoundEffect, type InputSnapshot } from '../types.ts';
import { firePlayerBullet } from './BulletSystem.ts';
import { clampTankToField, tryMoveTank, updateIceSliding } from './MovementSystem.ts';
