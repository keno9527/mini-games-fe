import { BULLET_SIZE, TANK_SIZE } from '../constants.ts';
import { rectsIntersect } from '../core/geometry.ts';
import { Bullet } from '../entity/Bullet.ts';
import type { Tank } from '../entity/Tank.ts';
import { SoundEffect, TankSide, type Direction } from '../types.ts';
import { getDirectionVector } from './MovementSystem.ts';
import { tryDropPowerUp } from './PowerUpSystem.ts';
