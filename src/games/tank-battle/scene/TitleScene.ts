...
import { Direction, type InputSnapshot } from '@/games/tank-battle/types.ts'
...
/** 标题下方的玩家坦克图标 */
function drawTankEmblem(context: CanvasRenderingContext2D, originX: number, originY: number): void {
