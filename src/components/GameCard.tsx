...
export default function GameCard({ game }: Props) {
  ...
  if (target.isExternal) {
    return (
      <a href={target.href} target="_blank" rel="noreferrer" className={cardClassName}>
        {content}
      </a>
    )
  }
  ...
  return (
    <Link to={target.href} className={cardClassName}>
      {content}
    </Link>
  )
}
